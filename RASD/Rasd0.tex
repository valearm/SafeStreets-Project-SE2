...
\includegraphics[scale=0.8]{Images/UML_diagram.jpg}
...
\newpage
 	 \includegraphics[scale=0.7]{MOCKUP/LOGINOOK.png}                  \hfill \includegraphics[scale=0.7]{MOCKUP/menuuser.png}
		 
		 \textbf{Figure 3.6:} Login view.  \hfill \textbf{Figure 3.7:} User Menu view.
		
  \includegraphics[scale=0.7]{MOCKUP/AMMENU.png}                  \hfill \includegraphics[scale=0.7]{MOCKUP/menua.png}
...
\includegraphics[scale=0.7]{MOCKUP/authtickets.png}                  \hfill \includegraphics[scale=0.71]{MOCKUP/authmember.png}
...
\begin{center}
\includegraphics[scale=0.45]{Progettiuse-cases/Imgusecases/use-caseuserOK.png}                 
...
\begin{center}
\includegraphics[scale=0.45]{Progettiuse-cases/Imgusecases/use-caseAuthoritymemberOK.png}                 
...
\newpage
 \includegraphics[scale=0.90]{images/usecase12ok.png}                  
...
\newpage
\includegraphics[scale=0.68]{Sequencediagrams/systemSuggestInterventionOK.png}                  
...
\includegraphics[scale=0.85]{Alloy/Alloy1-43.png}   

\end{center}

\begin{center}

\includegraphics[scale=0.85]{Alloy/Alloy44-86.png}   

\end{center}

\begin{center}

\includegraphics[scale=0.85]{Alloy/Alloy87-129.png}   
...
\includegraphics[scale=0.85]{Alloy/Alloy130-172.png}   
...
\includegraphics[scale=0.85]{Alloy/Alloy173-215.png}   

\end{center}

\begin{center}

\includegraphics[scale=0.85]{Alloy/Alloy216-258OK.png}   

\end{center}

\begin{center}

\includegraphics[scale=0.80]{Alloy/Alloy259-301OK.png}   
...
\includegraphics[scale=0.80]{Alloy/Alloy302-318OK.png}   
...
\includegraphics[scale=0.32]{Alloy/userSendNotification.png}   
\textbf{Figure: 4.1} World generated 1: User sends a notification.
\end{center}

\begin{center}

\includegraphics[scale=0.27]{Alloy/memberHandlerNotification.png}   
\textbf{Figure: 4.2} World generated 2: AM handles a violation.
\vspace{1.5cm}

\includegraphics[scale=0.30]{Alloy/ticketGeneration.png}   
...
\includegraphics[scale=0.30]{Alloy/StatisticGenerated.png}   
...
\includegraphics[scale=0.6]{Alloy/userSendNotificationReport.png}   
\vspace{3mm}

\includegraphics[scale=0.58]{Alloy/memberHandlerNotificationReport.png}   
\vspace{3mm}

\includegraphics[scale=0.6]{Alloy/ticketGenerationReport.png}   
\vspace{3mm}

\includegraphics[scale=0.65]{Alloy/StatisticGeneratedReport.png}   
\vspace{3mm}
...
\includegraphics[scale=1]{Alloy/Immagine.png}   
\vspace{3mm}
