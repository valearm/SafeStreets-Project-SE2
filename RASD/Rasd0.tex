...
%% formatting %%
		 ...
		 \includegraphics[scale=0.95]{MOCKUP/MOCKUPFIRST.png}                  \hfill \includegraphics[scale=0.95]{MOCKUP/login.png}
		 
		 \textbf{Figure 3.1:} SafeStreets home view.  \hfill \textbf{Figure 3.2:} SafeStreets Login.
		
\newpage
 	 \includegraphics[scale=0.7]{MOCKUP/signup.png}                  \hfill \includegraphics[scale=0.7]{MOCKUP/menuuser.png}
